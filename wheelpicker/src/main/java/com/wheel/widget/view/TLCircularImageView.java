...
public class TLCircularImageView extends ImageView {

	public TLCircularImageView(Context context) {
		super(context);
	}

	public TLCircularImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public TLCircularImageView(Context context, AttributeSet attrs, int defStyle) {
