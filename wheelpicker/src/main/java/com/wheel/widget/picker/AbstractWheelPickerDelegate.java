...
import com.wheel.widget.adapter.WheelAdapter;
import com.wheel.widget.view.AbsWheelView;
import com.wheel.widget.view.BorderLabelTextView;
...
abstract class AbstractWheelPickerDelegate implements IWheelPickerDelegate {
    ...
    public void setSelection(int component, int row) {
        if (component > 0) {
            WheelView wheelView = mWheelViews.get(component-1);
