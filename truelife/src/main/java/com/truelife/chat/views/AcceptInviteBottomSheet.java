package com.truelife.chat.views;
...
import com.truelife.chat.adapters.PartialGroupUsersAdapter;
...
public class AcceptInviteBottomSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initViews(view);
        tvFetchingGroup.setText(TLApplication.Companion.context().getResources().getString(R.string.fetching_group));
    ...
    public void showData(User user, int usersCount) {
        ...
        com.truelife.chat.model.realms.Group group = user.getGroup();
        if (group != null) {
            String groupCreator = TLApplication.Companion.context().getResources().getString(R.string.created_by) + " " + ContactUtils.queryForNameByNumber( group.getCreatedByNumber());
            tvGroupCreator.setText(groupCreator);
            tvParticipantsCount.setText(usersCount + " " + TLApplication.Companion.context().getResources().getString(R.string.participants));
    ...
    public void showLoadingOnJoin() {
        cgroupGroupInfo.setVisibility(View.GONE);
        cgroupFetching.setVisibility(View.VISIBLE);
        tvFetchingGroup.setText(TLApplication.Companion.context().getResources().getString(R.string.loading));
