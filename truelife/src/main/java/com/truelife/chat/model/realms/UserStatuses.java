...
public class UserStatuses extends RealmObject {
    ...
    private com.truelife.chat.model.realms.User user;
    private RealmList<com.truelife.chat.model.realms.Status> statuses;
    private boolean areAllSeen;

    public UserStatuses(String userId, long lastStatusTimestamp, com.truelife.chat.model.realms.User user, RealmList<com.truelife.chat.model.realms.Status> statuses) {
        this.userId = userId;
    ...
    public com.truelife.chat.model.realms.User getUser() {
        return user;
    }

    public RealmResults<com.truelife.chat.model.realms.Status> getMyStatuses() {
    ...
    public RealmResults<com.truelife.chat.model.realms.Status> getFilteredStatuses() {
        return statuses
    ...
    public RealmList<com.truelife.chat.model.realms.Status> getStatuses() {
        return statuses;
    }
