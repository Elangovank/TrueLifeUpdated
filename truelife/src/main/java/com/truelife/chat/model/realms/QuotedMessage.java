...
public class QuotedMessage extends RealmObject {
    ...
    private com.truelife.chat.model.realms.RealmContact contact;
    //when sending or receiving a location
    private RealmLocation location;
    private boolean isBroadcast;

    private com.truelife.chat.model.realms.Status status;

    public com.truelife.chat.model.realms.Status getStatus() {
        return status;
    }
    ...
    public static com.truelife.chat.model.realms.Message quotedMessageToMessage(QuotedMessage quotedMessage) {
        com.truelife.chat.model.realms.Message message = new com.truelife.chat.model.realms.Message();
    ...
    public com.truelife.chat.model.realms.RealmContact getContact() {
        return contact;
    }
