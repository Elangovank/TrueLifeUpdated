...
public class GroupEvent extends RealmObject implements Parcelable {
    ...
    public void createGroupEvent(com.truelife.chat.model.realms.User group, String eventId) {
        com.truelife.chat.model.realms.Message message = new Message();
    ...
    public static String extractString(String messageContent, RealmList<com.truelife.chat.model.realms.User> users) {
        try {
            ...
            String finalText = "";
            Resources resources = TLApplication.Companion.context().getResources();
    ...
    private static String getUserNameFromGroupEvent(String number, RealmList<com.truelife.chat.model.realms.User> users) {
    ...
    public static final Creator<GroupEvent> CREATOR = new Creator<GroupEvent>() {
