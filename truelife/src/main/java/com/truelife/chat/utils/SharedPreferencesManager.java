...
import com.truelife.chat.model.constants.NetworkType;
...
public class SharedPreferencesManager {
    ...
    public static void deleteUser() {
        ...
        SharedPreferencesManager.saveMyThumbImg("");
        SharedPreferencesManager. savePhoneNumber("");
        SharedPreferencesManager.saveMyStatus("");
        SharedPreferencesManager.saveMyUsername("");
        SharedPreferencesManager.saveMyPhoto("");
    }
}
