...
class FireManager {
    ...
    fun updateMyPersonalIdentifiables(value: String): Completable {
        return RxFirebaseDatabase.setValue(FireConstants.usersRef.child(uid).child("personaldata"), value)
    }
