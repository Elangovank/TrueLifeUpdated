...
import com.truelife.chat.model.realms.Broadcast;
import com.truelife.chat.model.realms.Chat;
import com.truelife.chat.model.realms.CurrentUserInfo;
import com.truelife.chat.model.realms.DeletedMessage;
import com.truelife.chat.model.realms.FireCall;
import com.truelife.chat.model.realms.Group;
import com.truelife.chat.model.realms.JobId;
...
public class RealmHelper {
    ...
    public void deleteMessageFromRealm(String chatId, String messageId, boolean deleteFile) {
        ...
        if (deleteFile && !messageToDelete.isTextMessage())
            com.truelife.chat.utils.FileUtils.deleteFile(messageToDelete.getLocalPath());
...
*/
    ...
    public void updateUserImg(String uid, String imgUrl, String localPath, String oldLocalPath) {
        ...
        com.truelife.chat.utils.FileUtils.deleteFile(oldLocalPath);
    ...
    public List<String> updateGroup(String groupId, DataSnapshot info, DataSnapshot usersSnapshot) {
        ...
        List<String> distinct = com.truelife.chat.utils.ListUtil.distinct(storedUids, serverUids);
        ...
        for (String uid : distinct) {
            ...
            //otherwise it's a deletion event
                ...
                //get user from group
                User userById = com.truelife.chat.utils.ListUtil.getUserById(uid, users);
                //check if exists
                if (userById != null) {
    ...
    public RealmResults<UserStatuses> getAllStatuses() {
        return realm.where(UserStatuses.class)
                ...
                .between(DBConstants.lastStatusTimestamp, com.truelife.chat.utils.TimeHelper.getTimeBefore24Hours(), Long.MAX_VALUE)
                .isNotEmpty("statuses")
                .findAll()
        ...
        if (status != null && userStatuses != null) {
            ...
            if (!userId.equals(FireManager.getUid())) {
                if (status.getLocalPath() != null)
                    com.truelife.chat.utils.FileUtils.deleteFile(status.getLocalPath());
            }
