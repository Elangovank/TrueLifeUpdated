    ...
    public static String getTypeText(int type) {
        switch (type) {
            ...
            case MessageType.RECEIVED_IMAGE:
                return TLApplication.Companion.context().getString(R.string.photo);

            case MessageType.SENT_VIDEO:
            case MessageType.RECEIVED_VIDEO:
                return TLApplication.Companion.context().getString(R.string.video);


            case MessageType.SENT_VOICE_MESSAGE:
            case MessageType.RECEIVED_VOICE_MESSAGE:
                return TLApplication.Companion.context().getString(R.string.voice_message);


            case MessageType.SENT_AUDIO:
            case MessageType.RECEIVED_AUDIO:
                return TLApplication.Companion.context().getString(R.string.audio);


            case MessageType.SENT_FILE:
            case MessageType.RECEIVED_FILE:
                return TLApplication.Companion.context().getString(R.string.file);


            case MessageType.SENT_LOCATION:
            case MessageType.RECEIVED_LOCATION:
                return TLApplication.Companion.context().getString(R.string.location);

            case MessageType.SENT_STICKER:
            case MessageType.RECEIVED_STICKER:
                return TLApplication.Companion.context().getString(R.string.sticker);
