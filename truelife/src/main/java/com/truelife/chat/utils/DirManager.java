...
public class DirManager {
    ...
    private static final String APP_FOLDER_NAME = TLApplication.Companion.context().getString(R.string.app_folder_name);
    ...
    public static String mainAppFolder() {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            file = new File(TLApplication.Companion.context().getExternalFilesDir(null) + "/" + APP_FOLDER_NAME + "/");
        } else {
