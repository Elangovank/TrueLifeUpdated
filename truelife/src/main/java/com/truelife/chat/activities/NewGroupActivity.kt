...
import com.truelife.chat.adapters.ForwardAdapter
import com.truelife.chat.adapters.NewGroupAdapter
import com.truelife.chat.adapters.NewGroupSelectedUsersAdapter
...
class NewGroupActivity : ForwardActivity(), ForwardAdapter.OnUserClick, NewGroupSelectedUsersAdapter.OnUserClick, ForwardActivity.SearchCallback {
    ...
    private lateinit var fabNext: ImageView
    ...
    private fun updateSelectedUsers(count: Int) {
        if (count == 0) {
            ...
            if (fabNext.visibility == View.VISIBLE) fabNext.visibility = View.GONE
        } else {
            if (fabNext.visibility != View.VISIBLE) fabNext.visibility = View.VISIBLE
