...
import com.truelife.chat.adapters.StatusSeenByAdapter;
import com.truelife.chat.adapters.StatusSeenByCallback;
...
import com.truelife.chat.model.realms.StatusSeenBy;
...
import com.truelife.chat.utils.StatusHelper;
import com.truelife.chat.utils.TimeHelper;
import com.truelife.chat.utils.Util;
import com.truelife.chat.utils.keyboard.KeyboardHeightObserver;
import com.truelife.chat.utils.keyboard.KeyboardHeightProvider;
import com.truelife.chat.utils.keyboard.KeyboardHelper;
import com.truelife.chat.utils.keyboard.KeyboardUtils;
...
import static com.truelife.chat.activities.main.messaging.ChatActivity.CAMERA_REQUEST;
import static com.truelife.chat.activities.main.messaging.ChatActivity.MAX_FILE_SIZE;
import static com.truelife.chat.activities.main.messaging.ChatActivity.PICK_CONTACT_REQUEST;
import static com.truelife.chat.activities.main.messaging.ChatActivity.PICK_GALLERY_REQUEST;
import static com.truelife.chat.activities.main.messaging.ChatActivity.PICK_LOCATION_REQUEST;
import static com.truelife.chat.activities.main.messaging.ChatActivity.PICK_MUSIC_REQUEST;
import static com.truelife.chat.activities.main.messaging.ChatActivity.PICK_NUMBERS_FOR_CONTACT_REQUEST;
import static com.truelife.chat.activities.main.messaging.ChatActivity.RECORD_START_AUDIO_LENGTH;
import static com.truelife.chat.utils.FontUtil.isFontExists;
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                switch (newState) {
                    case BottomSheetBehavior.STATE_EXPANDED:
                        ...
                        rvSeenBy.animate().translationY(-DpUtil.toPixel(50, TLApplication.Companion.context())).start();
