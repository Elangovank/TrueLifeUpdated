...
import com.truelife.chat.Base
import com.truelife.chat.extensions.observeChildEvent
import com.truelife.chat.extensions.setValueRx
import com.truelife.chat.extensions.toMap
...
abstract class BaseActivity : AppCompatActivity(), Base {
    ...
    override fun onResume() {
        ...
        if (enablePresence()) {
            ...
            TLApplication.baseActivityResumed()
        }

        (this.application as? TLApplication)?.let { application ->
            if (TLApplication.isHasMovedToForeground() && SharedPreferencesManager.isFingerprintLockEnabled()) {
    ...
    override fun onPause() {
        ...
        if (enablePresence()) {
            ...
            TLApplication.baseActivityPaused()
        }
