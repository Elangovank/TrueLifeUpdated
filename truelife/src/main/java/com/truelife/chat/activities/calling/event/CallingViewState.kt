...
package com.truelife.chat.activities.calling.event

import android.view.SurfaceView
import com.truelife.chat.activities.calling.model.CallEndedReason
...
sealed class CallingViewState {
    ...
    class FlipCamera(val isFlip: Boolean) : CallingViewState()
