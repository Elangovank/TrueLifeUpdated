...
import com.truelife.chat.activities.calling.model.BeforeCallEventHandler;
import com.truelife.chat.activities.calling.model.DuringCallEventHandler;
...
public class MyEngineEventHandler extends IRtcEngineEventHandler {
    ...
    private final ConcurrentHashMap<com.truelife.chat.activities.calling.model.AGEventHandler, Integer> mEventHandlerList = new ConcurrentHashMap<>();

    public void addEventHandler(com.truelife.chat.activities.calling.model.AGEventHandler handler) {
        this.mEventHandlerList.put(handler, 0);
    }

    public void removeEventHandler(com.truelife.chat.activities.calling.model.AGEventHandler handler) {
    ...
    public void onConnectionStateChanged(int state, int reason) {
        ...
        Iterator<com.truelife.chat.activities.calling.model.AGEventHandler> it = mEventHandlerList.keySet().iterator();
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_CONNECTION_STATE_CHANGED, new Object[]{state, reason});
            }
        }
    }
    ...
    public void onRemoteVideoStats(RemoteVideoStats stats) {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_USER_VIDEO_STATS, new Object[]{stats});
            }
        }
    }
            ...
            if (handler instanceof DuringCallEventHandler) {
                ...
                switch (state) {
                    case REMOTE_VIDEO_STATE_STOPPED:
                        ...
                        ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_USER_VIDEO_MUTED, new Object[]{uid, true});
                        break;
                    case REMOTE_VIDEO_STATE_DECODING:
                        if (reason == REMOTE_VIDEO_STATE_REASON_REMOTE_UNMUTED){
                            ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_USER_VIDEO_MUTED, new Object[]{uid, false});
                        }else {
    ...
    public void onAudioVolumeIndication(AudioVolumeInfo[] speakerInfos, int totalVolume) {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_SPEAKER_STATS, new Object[]{(Object) speakerInfos});
            }
        }
    }
    ...
    public void onError(int error) {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_AGORA_MEDIA_ERROR, new Object[]{error, RtcEngine.getErrorDescription(error)});
            }
        }
    }
    ...
    public void onStreamMessage(int uid, int streamId, byte[] data) {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_DATA_CHANNEL_MSG, new Object[]{uid, data});
            }
        }
    }
    ...
    public void onStreamMessageError(int uid, int streamId, int error, int missed, int cached) {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_AGORA_MEDIA_ERROR, new Object[]{error, "on stream msg error " + (uid & 0xFFFFFFFFL) + " " + missed + " " + cached});
            }
        }
    }
    ...
    public void onConnectionLost() {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_APP_ERROR, new Object[]{NO_CONNECTION_ERROR});
            }
        }
    }
    ...
    public void onAudioRouteChanged(int routing) {
        ...
        while (it.hasNext()) {
            com.truelife.chat.activities.calling.model.AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(com.truelife.chat.activities.calling.model.AGEventHandler.EVENT_TYPE_ON_AUDIO_ROUTE_CHANGED, new Object[]{routing});
            }
        }
    }
