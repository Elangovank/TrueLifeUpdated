 ...
 */
class ProfileFriendsListAdapter(
    private val mContext: FragmentActivity,
    var mUList: List<Profile.FriendsDetails>, val listener: ProfileClickListener
) : RecyclerView.Adapter<ProfileFriendsListAdapter.ViewHolder>() {
    ...
    fun getNewsInfo(position: Int): Profile.FriendsDetails {
    ...
    fun updateAdapter(
        aUList: List<Profile.FriendsDetails>
    ) {
        mUList = aUList
    }
