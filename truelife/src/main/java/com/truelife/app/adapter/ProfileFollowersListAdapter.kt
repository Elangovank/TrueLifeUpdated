 ...
 */
class ProfileFollowersListAdapter(
    private val mContext: FragmentActivity,
    var mUList: List<Profile.FollowersDetails>, val listener: ProfileClickListener
) : RecyclerView.Adapter<ProfileFollowersListAdapter.ViewHolder>() {
    ...
    fun getNewsInfo(position: Int): Profile.FollowersDetails {
    ...
    fun updateAdapter(
        aUList: List<Profile.FollowersDetails>
    ) {
        mUList = aUList
    }
