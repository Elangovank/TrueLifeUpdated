...
class FriendsListAdapter(
    ...
    var mUList: List<FriendsList>, val listener: ClickListener
    ...
    override fun onCreateViewHolder(
        ...
        val v: View = LayoutInflater.from(mContext)
            .inflate(R.layout.friends_block_list_adapter, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(aHolder: ViewHolder, position: Int) {
        ...
        if (!data.profile_image.isNullOrEmpty())
            data.profile_image?.let { Utility.loadImageWithGender(it, aHolder.myMenuImageIcon,data.gender!!) }
    ...
    fun getNewsInfo(position: Int): FriendsList {
    ...
    inner class ViewHolder(aView: View) :
        ...
        init {
            ...
            mUnBlockBtn = aView.findViewById(R.id.inflate_menu_un_block_btn)
        }
    }
