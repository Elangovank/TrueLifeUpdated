 ...
 */
(c: Context?, m: Int, url: String, rt: Int) : VolleyClient(c, m, url, rt), com.android.volley.Response.Listener<String> {
    ...
    override fun onResponse(response: String) {
        try {
            if (l != null) {
                val r = VolleyClient.parseResponse(response, responseType)
                if (r != null) {
