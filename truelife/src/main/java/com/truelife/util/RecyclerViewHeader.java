...
public class RecyclerViewHeader extends RelativeLayout {
     ...
     */
    public final void attachTo(final RecyclerView recycler) {
        validate(recycler);
    ...
    private static class RecyclerViewDelegate {
        ...
        private RecyclerViewDelegate(final RecyclerView recyclerView) {
    ...
    private static class LayoutManagerDelegate {
        ...
        private LayoutManagerDelegate(RecyclerView.LayoutManager manager) {
